Vagrant.configure("2") do |config|
  ...
  config.vm.define "frontend" do |frontend|
    frontend.vm.box = "geerlingguy/centos7"
	frontend.vm.hostname = "vproapp"
    frontend.vm.network "private_network", ip: "192.168.3.94"
  ...
  config.vm.define "prodfrontend" do |prodfrontend|
    prodfrontend.vm.box = "geerlingguy/centos7"
	prodfrontend.vm.hostname = "prodvproapp"
    prodfrontend.vm.network "private_network", ip: "192.168.3.96"
	prodfrontend.vm.provider "virtualbox" do |vb|
     vb.memory = "1024"
	 vb.cpus = "1"
     vb.name = "prod_vproapp"
	end
  end
